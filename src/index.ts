...
export default class PluginDouban extends Plugin {
    ...
    onunload() {
        ...
        this.mobileReadingCenterDialog = null;
    ...
    private openReadingCenter() {
        if (this.isMobile) {
            this.openMobileReadingCenter();
        } else {
            void this.openReadingCenterTab();
        }
    }

    private openMobileReadingCenter() {
        this.mobileReadingCenterDialog?.close?.();
        this.mobileReadingCenterDialog = null;
        ...
        dialogRef = svelteDialog({
            ...
            callback: () => {
                if (this.mobileReadingCenterDialog === dialogRef) {
                    this.mobileReadingCenterDialog = null;
                }
            },
        });
        this.mobileReadingCenterDialog = dialogRef;
        dialogRef.dialog.element.classList.add("siyuan-douban-mobile-dialog");
    }
