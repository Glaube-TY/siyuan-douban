...
> **注意：** 本目录是上游接口能力参考，不代表本插件当前全部使用。插件开发请优先阅读 `docs/weread-api-reference-current.md`。若与主文档冲突，以主文档为准。
...
> 本插件当前同步主链路暂不使用 `/book/underlines` 接口；仅作为上游能力参考。新增功能前必须先确认真实返回并更新主文档。
